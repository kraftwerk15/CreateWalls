	...
	class ThisApplication : IExternalCommand
	{
		public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
		{
			...
			void place_WallsDoorsWindows()
			{
				...
				List<List<Wall>> walls = Create_House_Shapes(n, door_RightWall, wind_RigthWall, door_LeftWall, wind_LeftWall, _heigth_);
			...
			// inputs: n=shape 
			List<List<Wall>> Create_House_Shapes(string n, bool a, bool b, bool c, bool d, double _heigth_)
			{
			...
			void CreateWindow(Wall _wall_, double _height_)
			{
